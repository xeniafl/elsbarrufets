...
existing_product_attributes2017 <- read_csv("existingproductattributes2017.csv")
new_product_attributes2017 <- read_csv("newproductattributes2017.csv")
```
...
# ANOVA calculation
```{r}
existingProd_without_outlier <- existing_product_attributes2017[!(existing_product_attributes2017$Volume > 6000),]
anova_without_outlier <- aov(existingProd_without_outlier$Volume ~
                               existingProd_without_outlier$ProductType)
summary(anova_without_outlier)
```
